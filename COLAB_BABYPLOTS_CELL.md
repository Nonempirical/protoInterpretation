# Google Colab Cell: BabyPlots UMAP Visualization

Copy and paste this entire cell into a Google Colab notebook.
...
- Make sure you have the `babyplots.min.js` file in `src/protoInterpretation/visualization/babyplots/`
- The cell will automatically load BabyPlots from the local file
- No pip installation of babyplots package needed!
